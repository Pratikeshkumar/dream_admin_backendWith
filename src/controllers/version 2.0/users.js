const { User, Avatar, Transaction, Gift, Video, UserRelationship, Like, Message, UserInteraction, Language, Hobbies, VideoView, ProfileVisit,Occupations } = require("../../models");
const fs = require('fs');
